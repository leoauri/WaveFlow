...
class TacotronSTFT(torch.nn.Module):
    def __init__(self, filter_length=1024, hop_length=256, win_length=1024,
                 ...
                 mel_fmax=None, ref_level_db=10., min_level_db=-100.):
    ...
    def mel_spectrogram_dbver(self, y):
        ...
        magnitudes = magnitudes.data
        mel_output = torch.matmul(self.mel_basis, magnitudes)
        S = audio_processing.amp_to_db(mel_output, self.min_level_db) - self.ref_level_db
    ...
    def dbmel_to_tacomel(self, mel):
        ...
        """
        denorm = audio_processing.denormalize(mel, self.min_level_db) + self.ref_level_db
